        ...
        NavigationStack {
            ZStack {
                ...
                ScrollView {
                    VStack {
                        VStack {
                            AsyncImage(url: URL(string: "https://i.scdn.co/image/ab67616d0000b27359a6022f671f929b9979011d")) { image in image
                                    .image?.resizable()
                        ...
                        VStack (alignment: .leading) {
                            Text("Persona 5 Royal Soundtrack")
                                .font(.title2)
                                .bold()
